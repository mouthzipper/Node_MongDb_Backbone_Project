define(['TambayanView', 'models/Contact', 'views/contact', 'text!templates/addcontact.html'],
function(TambayanView, Contact, ContactView, addcontactTemplate)
{
  var addcontactView = TambayanView.extend({
    el: $('#content'),
