define(['TambayanView', 'views/chatsession', 'views/chatitem', 'text!templates/chat.html'],
function(TambayanView, ChatSessionView, ChatItemView, chatItemTemplate) {
  var chatView = TambayanView.extend({
    el: $('#chat'),
